...
exports.register = function(req, res) {
    ...
    if (userId && userPw) { //id와 password를 모두 받았을 경우
        ...
        userController.createUserData(databaseRef, userId, userPw);
...
exports.update = function(req, res) {
    ...
    if (uid) {
        ...
        userController.updateUserData(databaseRef, uid, id, password);
...
exports.delete = function(req, res) {
    ...
    if (uid) { //UID를 입력받았을 경우
        userController.deleteUserData(databaseRef, uid);
